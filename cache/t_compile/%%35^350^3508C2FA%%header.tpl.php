...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'article/header.tpl', 15, false),array('modifier', 'strip_tags', 'article/header.tpl', 17, false),array('modifier', 'escape', 'article/header.tpl', 17, false),array('modifier', 'assign', 'article/header.tpl', 39, false),array('modifier', 'to_array', 'article/header.tpl', 131, false),array('function', 'call_hook', 'article/header.tpl', 28, false),array('function', 'translate', 'article/header.tpl', 90, false),array('function', 'url', 'article/header.tpl', 129, false),)), $this); ?>
<?php echo '<?xml'; ?>
...
<head>
 ...
 | <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedTitle($this->_tpl_vars['issue']))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</title>
...
/lib/pkp/js/lib/jquery/plugins/jqueryUi.min.js"></script>
	...
	<!-- Breadcrumb Journal Title -->
	<script type="text/javascript" src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/js/brdTitle.js"></script>

	<!-- Set bibtex as default citation -->
	<script type="text/javascript" src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/js/defaultCitation.js"></script>
