<?php /* Smarty version 2.6.26, created on 2016-02-03 13:49:01
         compiled from article/article.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'article/article.tpl', 26, false),array('modifier', 'escape', 'article/article.tpl', 26, false),array('modifier', 'strip_unsafe_html', 'article/article.tpl', 46, false),array('modifier', 'nl2br', 'article/article.tpl', 53, false),array('modifier', 'to_array', 'article/article.tpl', 78, false),array('function', 'translate', 'article/article.tpl', 30, false),array('function', 'call_hook', 'article/article.tpl', 45, false),array('function', 'url', 'article/article.tpl', 78, false),array('block', 'iterate', 'article/article.tpl', 108, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
	<?php endif; ?>
<?php else: ?>
	<div id="topBar"><h3 id="jTitle" style="display:none"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedTitle($this->_tpl_vars['issue']))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</h3>
