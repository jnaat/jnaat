<?php /* Smarty version 2.6.26, created on 2016-04-19 16:04:58
         compiled from about/submissions.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'about/submissions.tpl', 22, false),array('function', 'translate', 'about/submissions.tpl', 22, false),array('modifier', 'escape', 'about/submissions.tpl', 33, false),array('modifier', 'nl2br', 'about/submissions.tpl', 48, false),array('modifier', 'string_format', 'about/submissions.tpl', 93, false),)), $this); ?>
...
<div>
	<h3>Preparing the LaTeX file of an accepted manuscript</h3>
	<p>The accepted manuscripts are assigned to a forthcoming issue only after the author provides the LaTeX file of the manuscript using the <a href="http://ictp.acad.ro/jnaat/style/anta.sty" download="jnaat.sty">style file</a> of the journal.</p>
	<p>We strongly suggest the download of the <a href="../../style/style_template-2015-11-11.zip" download="jnaat-style-template">template files archive</a>, which contains a template file and the style file of the journal. The template file contains standard fields to be filled/replaced, as well as certain usual examples to follow in the LaTeX editing of the paper.</p>
</div>
<div class="separator">&nbsp;</div>
