...
<head>
	<title>{$article->getLocalizedTitle()|strip_tags|escape} | {$article->getFirstAuthor(true)|strip_tags|escape} | {$currentJournal->getLocalizedTitle($issue)|strip_tags|escape}</title>
	...
	<script type="text/javascript" src="{$baseUrl}/js/brdTitle.js"></script>

	<!-- Set bibtex as default citation -->
	<script type="text/javascript" src="{$baseUrl}/js/defaultCitation.js"></script>
